...
@Component({
  selector: 'app-hangman-quesstion',
  templateUrl: './hangman-quesstion.component.html',
  styleUrl: './hangman-quesstion.component.css'
})
export class HangmanQuesstionComponent implements OnInit, OnChanges {
